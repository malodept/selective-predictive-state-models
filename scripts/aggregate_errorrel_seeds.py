...
RUN_DIRS = [
    Path("outputs/tartanair_resnet18_error_reliability_seed0"),
    Path("outputs/tartanair_resnet18_error_reliability_seed1"),
    Path("outputs/tartanair_resnet18_error_reliability_seed2"),
]
...
def main() -> None:
    ...
    out = Path("reports/tables/errorrel_multiseed_summary.md")
    out.parent.mkdir(parents=True, exist_ok=True)

    with out.open("w", encoding="utf-8") as f:
        f.write("# Error-supervised reliability multi-seed summary\n\n")
