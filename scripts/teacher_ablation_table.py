...
RUNS = {
    ...
    "DINOv2 L2 heuristic": Path("outputs/tartanair_dinov2_l2_full/metrics.json"),
    "DINOv2 L2 error-rel": Path("outputs/tartanair_dinov2_l2_error_reliability/metrics.json"),
}
...
def main() -> None:
    ...
    out = Path("reports/tables/teacher_ablation_table.md")
