...
mkdir -p logs/v31_multiseed_capacity_ladder
mkdir -p reports/tables/protocol/pybullet_obstacle_rgb_encoder/v31_multiseed_capacity_ladder
...
run_model () {
  ...
  REPORT="reports/tables/protocol/pybullet_obstacle_rgb_encoder/v31_multiseed_capacity_ladder/${NAME}_seed${SEED}.json"
...
# Missing tiny seeds
run_model tiny_full 64 1 4 1
run_model tiny_full 64 1 4 2

# Missing medium seeds
run_model medium_full 192 2 4 1
run_model medium_full 192 2 4 2

echo "DONE v31A missing capacity seeds"
