...
- output: `outputs/counterfactual/pybullet_obstacles_rgb_v5_3_ood/block3_h36_seed13/mixed_hard_state_disjoint_v0_groups.npz`
- groups total: `4000`
...
| quantity | value |
| --- | ---: |
| mean start-position distance | 0.046794 |
| median start-position distance | 0.000455 |
| p95 start-position distance | 0.139284 |
