...
- checkpoint: `outputs/counterfactual/pybullet_obstacles_rgb_scale/mixed_hard/delta_transformer/action_only_seed0/checkpoint.pt`
- mode: `action_only`
- test groups: `1000`
- top-1: `0.362000`
- mean rank: `2.129000`
...
| --- | ---: | ---: | ---: |
| same_state_diff_action | 0.939000 | 0.065928 | 2000 |
| same_action_diff_state | 0.496500 | -0.000963 | 2000 |
