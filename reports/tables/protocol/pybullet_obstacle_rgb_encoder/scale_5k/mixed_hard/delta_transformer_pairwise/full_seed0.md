...
- checkpoint: `outputs/counterfactual/pybullet_obstacles_rgb_scale/mixed_hard/delta_transformer/full_seed0/checkpoint.pt`
- mode: `full`
- test groups: `1000`
- top-1: `0.998000`
- mean rank: `1.003000`
...
| --- | ---: | ---: | ---: |
| same_state_diff_action | 0.998500 | 0.208998 | 2000 |
| same_action_diff_state | 1.000000 | 0.224082 | 2000 |
