...
- checkpoint: `outputs/counterfactual/pybullet_obstacles_rgb_scale/mixed_hard/delta_transformer/full_seed2/checkpoint.pt`
- mode: `full`
- test groups: `1000`
- top-1: `0.997000`
- mean rank: `1.005000`
...
| --- | ---: | ---: | ---: |
| same_state_diff_action | 0.999500 | 0.213013 | 2000 |
| same_action_diff_state | 0.998000 | 0.229006 | 2000 |
