...
- checkpoint: `outputs/counterfactual/pybullet_obstacles_rgb_scale/mixed_hard/delta_transformer/full_seed1/checkpoint.pt`
- mode: `full`
- test groups: `1000`
- top-1: `0.998000`
- mean rank: `1.006000`
...
| --- | ---: | ---: | ---: |
| same_state_diff_action | 0.999000 | 0.212608 | 2000 |
| same_action_diff_state | 0.998000 | 0.221338 | 2000 |
