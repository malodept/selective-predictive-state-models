...
- data: `outputs/counterfactual/pybullet_obstacles_rgb_v33_ood_grid/block2_h36_seed22/pybullet_obstacle_rgb_v1_ood_block2_h36_seed22_dinov2_vits14_pool4.npz`
- output: `outputs/counterfactual/pybullet_obstacles_rgb_v33_ood_grid/block2_h36_seed22/mixed_hard_state_disjoint_v0_groups.npz`
- groups total: `10000`
...
| quantity | value |
| --- | ---: |
| mean start-position distance | 0.047589 |
| median start-position distance | 0.000871 |
| p95 start-position distance | 0.140342 |
| blocked-mismatch fraction | 0.699175 |
