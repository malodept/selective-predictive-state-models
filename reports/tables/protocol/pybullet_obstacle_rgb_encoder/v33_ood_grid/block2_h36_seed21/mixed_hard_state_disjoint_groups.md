...
- data: `outputs/counterfactual/pybullet_obstacles_rgb_v33_ood_grid/block2_h36_seed21/pybullet_obstacle_rgb_v1_ood_block2_h36_seed21_dinov2_vits14_pool4.npz`
- output: `outputs/counterfactual/pybullet_obstacles_rgb_v33_ood_grid/block2_h36_seed21/mixed_hard_state_disjoint_v0_groups.npz`
- groups total: `10000`
...
| quantity | value |
| --- | ---: |
| mean start-position distance | 0.047503 |
| median start-position distance | 0.000256 |
| p95 start-position distance | 0.140581 |
| blocked-mismatch fraction | 0.698875 |
