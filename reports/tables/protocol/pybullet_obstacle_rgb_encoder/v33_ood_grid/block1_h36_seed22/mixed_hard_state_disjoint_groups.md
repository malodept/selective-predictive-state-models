...
- data: `outputs/counterfactual/pybullet_obstacles_rgb_v33_ood_grid/block1_h36_seed22/pybullet_obstacle_rgb_v1_ood_block1_h36_seed22_dinov2_vits14_pool4.npz`
- output: `outputs/counterfactual/pybullet_obstacles_rgb_v33_ood_grid/block1_h36_seed22/mixed_hard_state_disjoint_v0_groups.npz`
- groups total: `10000`
...
| quantity | value |
| --- | ---: |
| mean start-position distance | 0.047281 |
| median start-position distance | 0.000374 |
| p95 start-position distance | 0.139510 |
| blocked-mismatch fraction | 0.594575 |
