...
- data: `outputs/counterfactual/pybullet_obstacles_rgb_v33_ood_grid/block4_h72_seed21/pybullet_obstacle_rgb_v1_ood_block4_h72_seed21_dinov2_vits14_pool4.npz`
- output: `outputs/counterfactual/pybullet_obstacles_rgb_v33_ood_grid/block4_h72_seed21/mixed_hard_state_disjoint_v0_groups.npz`
- groups total: `10000`
...
| quantity | value |
| --- | ---: |
| mean start-position distance | 0.042979 |
| median start-position distance | 0.000098 |
| p95 start-position distance | 0.127948 |
