...
\small
\resizebox{\textwidth}{!}{%
\begin{tabular}{p{0.17\textwidth}p{0.22\textwidth}p{0.25\textwidth}p{0.31\textwidth}}
\toprule
Level & Diagnostic question & Failure hidden by scalar accuracy & SPSM evidence \\
\midrule
...
\caption{Predictive usefulness stack. SPSM evaluates latent world models through multiple diagnostic levels rather than a single scalar accuracy: counterfactual discrimination, failure-axis diagnosis, interventional value-of-computation, predicted-latent calibration, and downstream actionability.}
\label{tab:predictive_usefulness_stack}
\end{table*}
