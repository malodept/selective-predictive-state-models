...
Table~\ref{tab:id_ablation} verifies this decomposition numerically: the full model combines state and action information, whereas incomplete-context ablations solve only part of the ranking problem.

\input{table_id_ablation.tex}
...
\input{tables/table_ood_summary.tex}
...
\input{tables/table_small_full_summary.tex}
...
\input{table_routing_key_cases.tex}
